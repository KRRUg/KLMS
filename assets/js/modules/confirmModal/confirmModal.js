...
(function ($, window, document, undefined) {
    ...
    $.extend(ConfirmModal.prototype, {
        ...
        _getModalHtml() {
            ...
            modalHtml += '<button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Nein</button>';
            modalHtml += '<button type="button" class="btn btn-sm btn-primary js-confirm">Ja</button>';
            modalHtml += '</div>';
            modalHtml += '</div>';
            modalHtml += '</div>';
            modalHtml += '</div>';
