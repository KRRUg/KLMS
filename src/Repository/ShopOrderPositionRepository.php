...
class ShopOrderPositionRepository extends ServiceEntityRepository
{
    ...
    public function countOrderedAddonsById(?UuidInterface $uuid = null, bool $paidOnly = false): array
    {
    ...
    public function countOrderedAddons(ShopAddon $addon, ?UuidInterface $uuid = null, bool $paidOnly = false): int
    {
        $qb = $this->getEntityManager()->createQueryBuilder();
